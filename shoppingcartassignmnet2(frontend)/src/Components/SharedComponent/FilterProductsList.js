...
import { filterProducts, sortProducts } from '../ReduxComponent/Actions/ProductActions'
      ...
      !this.props.filterProducts ?
        ...
        : (
          <div className='filter'>
            <div className='filter-result'>{!this.props.filteredProducts ? 0:this.props.filteredProducts.length} Products</div>
